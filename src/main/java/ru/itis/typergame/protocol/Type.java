...
public class Type {
    ...
    public static final int RECORD_GET = 7;
    public static final int RECORD_GET_MAX_SIZE = 1000;
    public static final int RECORD_GET_ANSWER = -7;
    public static final int RECORD_GET_ANSWER_MAX_SIZE = 1000;
